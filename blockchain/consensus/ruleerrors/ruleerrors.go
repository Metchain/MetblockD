...
type ErrMissingTxOut struct {
	MissingOutpoints []*external.DomainOutpoint
}
...
func NewErrMissingTxOut(missingOutpoints []*external.DomainOutpoint) error {
...
type ErrMissingParents struct {
	MissingParentHashes []*external.DomainHash
}
...
func NewErrMissingParents(missingParentHashes []*external.DomainHash) error {
	return errors.WithStack(RuleError{
