...
func (c *rPCClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (RPC_MessageStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &RPC_ServiceDesc.Streams[0], "/proto.RPC/MessageStream", opts...)
	if err != nil {
		return nil, err
	}
...
type RPC_MessageStreamClient interface {
	Send(*MetchainMessage) error
	Recv() (*MetchainMessage, error)
	grpc.ClientStream
}
...
func (x *rPCMessageStreamClient) Send(m *MetchainMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*MetchainMessage, error) {
	m := new(MetchainMessage)
...
func (x *rPCMessageStreamServer) Send(m *MetchainMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*MetchainMessage, error) {
	m := new(MetchainMessage)
...
func (c *p2PClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (P2P_MessageStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &P2P_ServiceDesc.Streams[0], "/proto.P2P/MessageStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *p2PMessageStreamClient) Send(m *MetchainMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*MetchainMessage, error) {
	m := new(MetchainMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *p2PMessageStreamServer) Send(m *MetchainMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*MetchainMessage, error) {
	m := new(MetchainMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
