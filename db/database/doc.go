/*
Package database provides a database for Metchain.
...
This defines the common interface by which data gets accessed in a generic Metchain
...
This defines the interface of a generic Metchain database transaction.
