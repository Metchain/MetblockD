...
func (x *MetchainMessage_GetBlockDagInfoRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "MetchainMessage_GetBlockDagInfoRequest is nil")
	}
	return &appmessage.GetBlockDAGInfoRequestMessage{}, nil
}

func (x *MetchainMessage_GetBlockDagInfoRequest) fromAppMessage(_ *appmessage.GetBlockDAGInfoRequestMessage) error {
	x.GetBlockDagInfoRequest = &GetBlockDagInfoRequestMessage{}
	return nil
}

func (x *MetchainMessage_GetBlockDagInfoResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "MetchainMessage_GetBlockDagInfoResponse is nil")
	}
...
func (x *MetchainMessage_GetBlockDagInfoResponse) fromAppMessage(message *appmessage.GetBlockDAGInfoResponseMessage) error {
	var err *RPCError
