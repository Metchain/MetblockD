...
func (c *uTXOsClient) UTXOStream(ctx context.Context, opts ...grpc.CallOption) (UTXOs_UTXOStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[0], "/protowire.UTXOs/UTXOStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *uTXOsClient) NFTStream(ctx context.Context, opts ...grpc.CallOption) (UTXOs_NFTStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[1], "/protowire.UTXOs/NFTStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *uTXOsClient) VWalletStream(ctx context.Context, opts ...grpc.CallOption) (UTXOs_VWalletStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[2], "/protowire.UTXOs/VWalletStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *uTXOsClient) WalletBalanceStream(ctx context.Context, opts ...grpc.CallOption) (UTXOs_WalletBalanceStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[3], "/protowire.UTXOs/WalletBalanceStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *uTXOsClient) UTXOAddress(ctx context.Context, opts ...grpc.CallOption) (UTXOs_UTXOAddressClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[4], "/protowire.UTXOs/UTXOAddress", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *uTXOsClient) WalletBalancesStream(ctx context.Context, opts ...grpc.CallOption) (UTXOs_WalletBalancesStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UTXOs_ServiceDesc.Streams[5], "/protowire.UTXOs/WalletBalancesStream", opts...)
	if err != nil {
		return nil, err
	}
