...
type grpcStream interface {
	Send(message *protowire.MetchainMessage) error
	Recv() (*protowire.MetchainMessage, error)
}
...
func (c *gRPCConnection) Start(router *routerpkg.Router) {
...
func (c *gRPCConnection) receive() (*protowire.MetchainMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.MetchainMessage) error {
